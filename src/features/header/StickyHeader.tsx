...
// The header's own UI: sticky, collapsing as you scroll down, and morphing
// between the landing page's hero and the inner-page bar. A client component,
// so `Header` fetches what it needs and passes it in.
