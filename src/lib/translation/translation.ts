 ...
 */
const translateFunction = (fullKey: string, languageCode: string) => {
	...
	// A translation was found, return it
...
export const getTranslateFunction =
	(languageCode: LanguageCode) => (fullKey: string) =>
		translateFunction(fullKey, languageCode);
